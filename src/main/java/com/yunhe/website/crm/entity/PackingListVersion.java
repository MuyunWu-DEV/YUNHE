...
@AllArgsConstructor
@Entity
@Table(name = "crm_pl_version",
        uniqueConstraints = @UniqueConstraint(name = "uk_pl_version", columnNames = {"packing_list_id", "version_no"}))
public class PackingListVersion extends BaseEntity {
