...
@AllArgsConstructor
@Entity
@Table(name = "crm_pi_version",
        uniqueConstraints = @UniqueConstraint(name = "uk_pi_version", columnNames = {"proforma_invoice_id", "version_no"}))
public class ProformaInvoiceVersion extends BaseEntity {
